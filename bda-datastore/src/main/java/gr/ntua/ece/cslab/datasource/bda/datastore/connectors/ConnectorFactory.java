...
import gr.ntua.ece.cslab.datasource.bda.common.storage.connectors.HBaseConnector;
import gr.ntua.ece.cslab.datasource.bda.common.storage.connectors.LocalFSConnector;
...
public class ConnectorFactory {
    ...
    public DatastoreConnector generateConnector(Connector conn){
        ...
        else if (conn instanceof SolrConnector) {
            connector = new DatastoreSolrConnector( (SolrConnector) conn);
        }
        return connector;
    }
}
