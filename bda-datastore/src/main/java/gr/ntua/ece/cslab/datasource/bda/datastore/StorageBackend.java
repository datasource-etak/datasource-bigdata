...
import gr.ntua.ece.cslab.datasource.bda.datastore.connectors.DatastoreConnector;
import gr.ntua.ece.cslab.datasource.bda.datastore.connectors.ConnectorFactory;
...
public class StorageBackend {
     ...
     *  be in json format). **/
    public void init(MasterData masterData, boolean withCreate) throws Exception {
        DTconnector.put(masterData, withCreate);
