...
import gr.ntua.ece.cslab.datasource.bda.datastore.datasets.online.parsers.xml.FilterIdsXMLResponseParser;
...
public class FilterId implements Serializable {
    ...
    public FilterId(Map<String, Object> ajson) {
        this.id = (String) ajson.get("id");
        this.index = (Integer) ajson.get("index");
    }
