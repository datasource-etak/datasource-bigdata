...
import gr.ntua.ece.cslab.datasource.bda.kpidb.KPIBackend;
import gr.ntua.ece.cslab.datasource.bda.kpidb.beans.KPI;
import gr.ntua.ece.cslab.datasource.bda.kpidb.beans.KPITable;
import gr.ntua.ece.cslab.datasource.bda.kpidb.beans.KeyValue;
 ...
 */
@RestController
@CrossOrigin(origins = {"https://datasource.qubiteq.gr","http://localhost:3000"}, allowCredentials = "true")
@RequestMapping("kpi")
