...
public class ConnectorFactory {
    ...
    public static final int CONNECTOR_SOLR_TYPE = 4;
    ...
    public Connector generateConnector(String fs, Configuration configuration)
        throws SystemConnectorException {
        ...
        try{
            if (connectorType == ConnectorFactory.CONNECTOR_SOLR_TYPE) {
                connector = new SolrConnector(fs, configuration);
            } else {
                throw new SystemConnectorException("This constructor doesn't support this operation.");
            }
        } catch (Exception e){
            e.printStackTrace();
            throw new SystemConnectorException("Could not create new connector.");
    ...
    public static int getConnectorType(String fs) {
        ...
        } else if (fs.contains("solr")) {
            return ConnectorFactory.CONNECTOR_SOLR_TYPE;
        } else {
