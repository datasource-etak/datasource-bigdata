...
package gr.ntua.ece.cslab.datasource.bda.common.storage;
...
import gr.ntua.ece.cslab.datasource.bda.common.storage.connectors.ConnectorFactory;
...
public class SystemConnector {
    ...
    private Connector solrConnector;
    ...
    private SystemConnector() throws SystemConnectorException {
        ...
        solrConnector = ConnectorFactory.getInstance().generateConnector(
            configuration.storageBackend.getSolrURL(),
            configuration
        );
    }
    ...
    public Connector getSolrConnector() {
